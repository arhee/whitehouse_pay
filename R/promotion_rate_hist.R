...
f = ggplot(mydata, aes(x=Y6_RateBin, fill=Gender)) + 
  geom_histogram(binwidth=5000, position='dodge') + 
  scale_fill_manual(values = cols) + 
  labs(x='Salary Increase per Year', y='Count') + 
  scale_x_discrete(labels=c('$0-$5k','$5-$10k','$10-$15k','$15-$20k','$20k+')) + 
  ggtitle('Promotion Rates for 2009-10 Junior WH Employees') + 
  theme_minimal()
