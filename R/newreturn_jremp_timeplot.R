...
p = ggplot(subdf, aes(Year, Count, color=Gender, fill=Gender)) + geom_line(size=2) + scale_color_manual(values = cols) + ggtitle('New and Returning Junior Employees at the WH (2010-2015)') + facet_wrap(~Type)
