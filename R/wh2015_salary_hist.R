...
f = ggplot(mydata, aes(x=Sal_Bin, fill=Gender)) + geom_bar(position='dodge', binwidth=20000) + scale_fill_manual(values = cols) + scale_x_discrete(labels=lbl) + geom_vline(xintercept=2.5, size=1, color='#777777') + geom_vline(xintercept=5.5, size=1, color='#777777') + ylab("Count") + xlab("Salary") + ggtitle('WH Salaries (2015)')
